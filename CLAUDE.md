...
This is a proof-of-concept repo for automated code review on the BigCommerce Data Solutions (DS) team. It mirrors the structure of the production `dw_airflow` repo.

## Repository Structure
- `dags/` — Airflow DAG Python files
- `ddl/fuji/` — Snowflake DDL/DML files organized by database/schema (e.g., `ddl/fuji/vz_apps/`)
- `code_reviews/` — Local review reports generated by `/code-review` (gitignored)
- `.claude/commands/code-review.md` — Slash command for local code review
